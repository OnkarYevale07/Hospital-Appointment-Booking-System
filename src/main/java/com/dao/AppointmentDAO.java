...
public class AppointmentDAO {
	...
	public List<Appointment> getAllAppointmentByDoctorLogin(int doctorId) {
		...
		try {
			...
			String sql = "select * from appointment where doctor_id=? order by appoint_date desc";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public List<Appointment> getAllAppointment() {
		...
		try {
			...
			String sql = "select * from appointment order by appoint_date DESC";
	...
	public List<Appointment> getAllAppointmentByDate(String sdate) {
		...
		try {
			...
			String sql = "select * from appointment where appoint_date=? order by appoint_date DESC";
